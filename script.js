...
const blobs = [
  { x: 100, y: 150, r: 80, color: "rgba(0, 120, 255, 0.3)", dx: 1, dy: 0.5 },
  { x: 400, y: 100, r: 60, color: "rgba(255, 0, 120, 0.3)", dx: -0.7, dy: 0.3 },
  { x: 700, y: 200, r: 100, color: "rgba(0, 200, 255, 0.3)", dx: 0.5, dy: -0.4 }
];
...
// Optional: GSAP to pulsate the blobs
...
// skeletonloader
   ...
   document.addEventListener('DOMContentLoaded', function() {
            ...
            // Simulate data loading (replace with your actual data loading)
            setTimeout(() => {
                // Hide skeleton and show actual content when data is loaded
